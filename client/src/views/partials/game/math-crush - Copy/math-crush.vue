  ...
  <div class="h-100">
    <div  class="game-container d-flex flex-column align-items-center flex-grow-1 mb-2  "> 
      <div class="d-flex justify-content-between align-items-center bg-white shadow-sm p-3 px-5 my-3 w-75">
        <p class="mb-0">Score:<span class="text-dark">{{game.stats.score}}</span></p>
        <p class="mb-0">Target: <span class="text-danger fw-bold">{{game.stats.target}}</span></p>
      </div>
...
<script setup>
  ...
  onMounted(() => {
    ...
    // while(crush.findStreak(game.stats)){ 
    //   crush.animateTiles()
    // }
